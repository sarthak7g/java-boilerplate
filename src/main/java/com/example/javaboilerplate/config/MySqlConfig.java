package com.example.javaboilerplate.config;
...
@EnableJpaRepositories(basePackages = {"com.example.javaboilerplate.repository"})
public class MySqlConfig {
  ...
  public EntityManagerFactory entityManagerFactory() throws PropertyVetoException {
    ...
    factory.setPackagesToScan("com.example.javaboilerplate.entity");
